...
int getWeatherAlert(String weatherNumber){
if(weatherNumber=="1"){return  0;}
if(weatherNumber=="2"){return  0;}
if(weatherNumber=="3"){return  0;}
if(weatherNumber=="4"){return  0;}
if(weatherNumber=="15"){return 0;}
return 1;
  }
...
void setup() {
 ...
 wifiManager.autoConnect("Netver");
  ...
  pinMode(ledPin, OUTPUT); // Pin for rain alert. Use 16 for built in red, and 2 for blue
}
    ...
    //displayInfo(c);
     ...
     if (c == '<' ) { // Sjekk om vi har starten på en xml node
      ...
      if(stage==1 && weather1==""){
         ...
         alertRain =getWeatherAlert(dataValue);
         ...
         alertRain = alertRain+getWeatherAlert(dataValue);
         dataValue="";
